...
**Ghezae, I.** (2023). Unique Turker 2: Python application for researchers to manage worker access to HITs on Amazon Mechanical Turk. [GitHub](https://github.com/isaiasghezae/unique-turker-2). [LibHunt](https://www.libhunt.com/r/unique-turker-2).
