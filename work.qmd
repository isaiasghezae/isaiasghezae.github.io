...
My research interests are broadly focused on `moral and political psychology`, with an emphasis on how group motivations may influence these processes. Additionally, I continue to be interested in research on cultural evolution and complex systems. To investigate these topics, I use methods from social psychology, cognitive science, and computational social science.
...
**Ghezae, I.** (2023). Unique Turker 2. \[Full-stack Flask app with a built-in database that can be used by Mechanical Turk requesters to prevent duplicate HIT access from Mechanical Turk workers\] [{{< fa brands github size=1.5x title="GitHub" >}}](https://github.com/isaiasghezae/unique-turker-2)
